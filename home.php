...
<body>
	...
	<div id="wrapper">
		...
		<div id="header">
			<!-- Begin Shell -->
			<div class="shell">
				<h1 id="logo"><a class="notext" href="#" title="Suncart">گرین کشت</a></h1>
				<div id="top-nav">
					<ul>
  ...
  <!-- Begin Navigation -->
		...
		<div id="slider">
			...
			<div class="shell">
				...
				<li>
						<img src="میوه جات.jpg" alt="Slide Image" />
						<div class="slide-entry">
							<h3><span>میوه جات</span><span class="small"> </span>تازه<span class="small"> میوه جات</span></h3> 
					
						
							<a href="products.php" class="button" title="Buy now"><span>خرید</span></a>
						</div>
					</li>
							
					<li>
						<img src="سبزیجات.jpg" alt="Slide Image" />
						<div class="slide-entry">
							<h4><span>برخی میوه ها</span><span class="small">&amp;</span><span>Frush</span>Crops</h4>
							<a href="products.php" class="button" title="Buy now"><span>خرید</span></a>
						</div>
					</li>
					<li>
						<img src="صیفی جات.jpg" alt="Slide Image" />
						<div class="slide-entry">
							<h3><span>برخی صیفیجات</span><span class="small">of </span> Male And Females Suits</h3> 
